        ...
        <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="badan_usaha" name="badan_usaha" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lokasi_usaha" name="lokasi_usaha" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="nama_kontrak">Nomor Kontrak</label>
                    <input type="number" class="form-control" id="nama_kontrak" name="nama_kontrak" required>
                </div>
