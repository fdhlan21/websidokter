        ...
        <div class="card-body">
            <form method="POST" action="">
                <div class="form-group">
                    <label for="text">Nama PPTK</label>
                    <input type="text" class="form-control" id="nomor" name="nomor" required>
                </div>
                <div class="form-group">
                    <label for="hari">NIP PPTK</label>
                    <input type="number" class="form-control" id="nomor" name="nomor" required>
                </div>
               
                <div class="form-group">
                    <label for="hari">Nomor</label>
                    <input type="number" class="form-control" id="nomor" name="nomor" required>
                </div>
               

                <div class="form-group">
                    <label for="hari">Tahun</label>
                    <select id="year" name="tahun" class="form-control"></select>
                </div>
               

                <div class="form-group">
                    <label for="hari">Nominal Belanja</label>
                    <input type="number" class="form-control" id="nomor" name="nomor" required>
                </div>
                ...
                <div class="form-group">
                    <label for="hari">Sumber Dana </label>
                    <input type="text" class="form-control" id="nomor" name="nomor" required>
                </div>
